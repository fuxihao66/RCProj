...
flags.DEFINE_integer("word_emb_size", 100, "Word emb size 100")
...
flags.DEFINE_integer("word_vocab_size", 40000, "the word vocab size is ")
flags.DEFINE_integer("char_vocab_size", 287, "the char vocab size is ")
...
def main(_):
    ...
    model = Model(config, scope=None, word2idx_dict=None, char2idx_dict=None)
