...
if __name__ == '__main__':
    ...
    train_data_dict = read_metadata('C:\\Users\\FU Xihao\\Documents\\My Documents\\RC_data\\train_v1.1.json', 'train')
    with open('C:\\Users\\FU Xihao\\Documents\\My Documents\\RC_data\\train.in', 'w') as train_in:
        for passage in train_data_dict['passage_selected']:
            train_in.write(passage+'\n')
    with open('C:\\Users\\FU Xihao\\Documents\\My Documents\\RC_data\\train.out', 'w') as train_out:
        for answer in train_data_dict['answers']:
            train_out.write(answer+'\n')
